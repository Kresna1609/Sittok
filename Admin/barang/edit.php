...
if(isset($_POST['update'])){
    ...
    if($file !="") {
      move_uploaded_file($_FILES['gbr']['name'], "../assets/img/barang/".basename($_FILES['gbr']['name']));
      $update=mysqli_query($koneksi,"UPDATE barang SET merk_barang='$merk_barang', harga='$harga', deskripsi='$deskripsi', gambar='$file', id_kategori='$id_kategori' WHERE id_barang='$id_barang'");
      unlink("../assets/img/barang/".$oldfile);
      ...
      $update=mysqli_query($koneksi,"UPDATE barang SET merk_barang='$merk', harga='$harga', diskripsi='$diskripsi', idkt='$id_kategori' WHERE id_barang='$id'");
