<footer>
<div class="container-fluid bg-secondary text-dark mt-5 pt-5"style= "background-color: #e0aaff" href="#section_footer">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-5">
                        ...
                        <form action="">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control border-0 py-4" placeholder="Masukkan Pesan"
                                    required="required" />
                            </div>
                            <div>
